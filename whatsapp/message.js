...
exports.sendFakeStatus = (from, teks, faketeks) => {
	xinz.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": faketeks, "jpegThumbnail": fs.readFileSync(`./media/load.jpeg`)} } } })
}
		...
		message: {
			"productMessage": {
				"product": {
					...
					"title": fake,
					"description": "ga kerasa bentar lagi lebaran",
					"currencyCode": "IDR",
		...
		message: {
			"productMessage": {
				"product": {
					...
					"title": fake,
					"description": "sahur makan,,, sahur sewa lonte",
					"currencyCode": "IDR",
					"priceAmount1000": "50000000",
					"retailerId": "Self Bot",
					"productImageCount": 1
